...
export const reducer = state => state.orders;
...
export const getLoadingCreatOrder = createSelector(
  reducer,
  data => data.isCreatingOrder,
);

export const getOrderCreatedData = createSelector(
  reducer,
  data => data.orderDataCreated,
);

export const getErrCreateOrder = createSelector(
  reducer,
  data => data.errCreateData,
);
